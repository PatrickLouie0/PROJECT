...
<body>
    ...
    if(isset($_POST["query"]))
    {
       ...
       $query = "SELECT * FROM available_product WHERE product_code LIKE '%".$search."%' OR product_name LIKE '%".$search."%' OR product_category LIKE '%".$search."% OR product_brandLIKE '%".$search."%'";
    }
    else
    {
       $query = "
