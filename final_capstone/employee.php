...
<!--sidebar-->
  <header >
		...
		<h2>
			<center>Store Employee Information</center>
		</h2>

<br><br> 
<center><div class="but1">	
<a style="color: white;" onclick="button8()"> NEW EMPLOYEE</a>
</div><br><br>
  ...
  <div class="col">
    ...
    <div class="but2">
    <center><button style="width: 200px;height: 50px; background-color: green;font-weight: bold;color:white; " class="but2" type="submit" name ="add_employee">Add Employee</button>
    </div>
		</form>
...
<?php if (isset($_SESSION['employee_updated'])): ?>
        <div class="<?=$_SESSION['alerts'];?>">
          <?= $_SESSION['employee_updated'];
  ...
  ?>
                        ...
                        <form action="employee.php" method="post">
                         ...
                         <a style="text-decoration: none;color: black" href="employee_update.php?id=<?= $res['id']; ?>" ><button>Edit</button></a>
                          </td>
                            <?php
