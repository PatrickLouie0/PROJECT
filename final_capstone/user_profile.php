...
header('location:Login.php');
 ...
 $manager_username = $_SESSION['user-manager'];
...
$near = '';
  ...
  $cons = mysqli_connect("localhost","root","","storenewdb");
  $sql = "SELECT `id`, `picture`, `username`, `password`, `lastname`, `firstname`, `middlename`, `number`, `email`, `address`, `status`, `date_time` FROM manager
    where username = '$manager_username'";
  
  $sqls = "SELECT  `id`,`store_name`, `store_street`, `store_brgy`, `store_municipality`, `store_province`, `near_to` FROM `store_details` ";
  ...
  $results = mysqli_query($cons,$sqls);
       while ($row = mysqli_fetch_array($results))
      {
        ...
        $barangay = $row['store_brgy'];
        $municipality = $row['store_municipality'];
...
<body>
  <div class="con">
      ...
      <header>      <p style="color: white;font-size: 25px; font-weight: bold;margin-left: 80px;" ><?php include("php/store_name.php")?></P></header>
...
<?php if (isset($_SESSION['messages'])): ?>
  ...
  <div class="picture" style="  position: absolute;
      top: 50px;
         right:70px;
         background-color: #f5f5f5;
         height: 390px;
  ...
  <div class="col">
    ...
    <button type="submit" class="update-button" name="update_user_info" >UPDATE</button>
   </div>
  ...
  <form method="post">
    <input type="text" name="id" value="<?php echo $store_id; ?>" hidden>
      <div class="row">
    <div class="col">
    <label>Store Name</label>
    <input type="text" class="form-control" value="<?php echo $store_name?>" placeholder = "Store Name" name="store_name"aria-label= "">
  </div>
</div>
    ...
    <div class="row">
      <div class="col">
    <label>Street</label>
    <input type="text" class="form-control" name="street" value="<?php echo $street?>" placeholder = "Street Name" aria-label= "">
  </div>
     <div class="col">
    <label>Barangay</label >
    <input type="text" class="form-control" name="barangay" value="<?php echo $barangay?>" placeholder = "Barangay Name" aria-label= "">
  </div>
  <div class="col">
    <label>Municipality</label>
    <input type="text" class="form-control" name="municipality" value="<?php echo $municipality?>" placeholder = "Municipality Name" aria-label= "">
  </div>
  </div>
  <div class="row">
     <div class="col">
    <label>Province</label >
    <input type="text" class="form-control" name="province" value="<?php echo $province?>" placeholder = "Province Name" aria-label= "">
  </div>
  <div class="col">
    <label>Near To</label>
    <input type="text" class="form-control" name="near" value="<?php echo $near?>" placeholder = "Near TO" aria-label= "">
  </div>
  </div>
   <button type="submit" class="update-buttons"  name = "update_store_info" >UPDATE</button>
</form>    
    </div>
